...
public class RegexGlobals {
    ...
    public final static String INT_DECLARATION_ASSIGNMENT_PARSER = "(\\s)*int\\s+"+NAME_FORMAT+"(\\s*,\\s*"+NAME_FORMAT
            +")*(\\s*=\\s*"+INT_FORMAT+")?\\s*(\\s*,\\s*\\s*"+NAME_FORMAT+"(\\s*=\\s*"+INT_FORMAT+")?)*;";
    public final static String INT_ASSIGNMENT_PARSER = "\\s*"+NAME_FORMAT+"\\s*+=\\s*"+INT_FORMAT+"\\s*(\\s*,\\s*"+
            NAME_FORMAT+"\\s*+=\\s*"+INT_FORMAT+"\\s*)*;";
    //double
    ...
    public final static String DOUBLE_DECLARATION_ASSIGNMENT_PARSER =  "(\\s)*int\\s+"+NAME_FORMAT+"(\\s*,\\s*"+NAME_FORMAT
    ...
    public final static String DOUBLE_ASSIGNMENT_PARSER = "\\s*"+NAME_FORMAT+"\\s*+=\\s*"+DOUBLE_FORMAT+
            "\\s*(\\s*,\\s*"+NAME_FORMAT + "\\s*+=\\s*"+DOUBLE_FORMAT+"\\s*)*;";
    //string
    public final static String STRING_FINAL_PARSER = "\\s*int\\s+final\\s+"+NAME_FORMAT+"\\s*=\\s*"+STRING_FORMAT+
    ...
    public final static String STRING_ASSIGNMENT_PARSER = "\\s*"+NAME_FORMAT+"\\s*+=\\s*"+STRING_FORMAT+"\\s*(\\s*," +
            "\\s*"+NAME_FORMAT+"" +
            "\\s*+=\\s*"+STRING_FORMAT+"\\s*)*;";
    public final static String STRING_DECLARATION_ASSIGNMENT_PARSER = "(\\s)*String\\s+"+NAME_FORMAT+"\\s*=\\s*"+STRING_FORMAT+
            "\\s*(\\s*,\\s*\\s*"+NAME_FORMAT+"\\s*=\\s*"+STRING_FORMAT+"\\s*)*(\\s*,\\s*"+STRING_FORMAT+")*;";
    //boolean
    public final static String BOOLEAN_FINAL_PARSER = "\\s*int\\s+final\\s+"+NAME_FORMAT+"\\s*=\\s*"+BOOLEAN_FORMAT+
    ...
    public final static String BOOLEAN_ASSIGNMENT_PARSER = "\\s*"+NAME_FORMAT+"\\s*+=\\s*"+BOOLEAN_FORMAT+"\\s*(\\s*," +
            "\\s*"+NAME_FORMAT+"" +
            "\\s*+=\\s*"+BOOLEAN_FORMAT+"\\s*)*;";
    public final static String BOOLEAN_DECLARATION_ASSIGNMENT_PARSER = "(\\s)*String\\s+"+NAME_FORMAT+"\\s*=\\s*"+
            BOOLEAN_FORMAT+ "\\s*(\\s*,\\s*"+NAME_FORMAT+"\\s*=\\s*"+BOOLEAN_FORMAT+"\\s*)*(\\s*,\\s*"+
            BOOLEAN_FORMAT+")*;";
    //char
    public final static String CHAR_FINAL_PARSER = "\\s*int\\s+final\\s+"+NAME_FORMAT+"\\s*=\\s*"+CHAR_FORMAT+
            "(\\s*,\\s*"+NAME_FORMAT+"\\s*=\\s*"+CHAR_FORMAT+")*\\s*;";
    public final static String CHAR_ASSIGNMENT_PARSER = "\\s*"+NAME_FORMAT+"\\s*+=\\s*"+CHAR_FORMAT+"\\s*(\\s*," +
            "\\s*"+NAME_FORMAT+"" +
            "\\s*+=\\s*"+CHAR_FORMAT+"\\s*)*;";
    public final static String CHAR_DECLARATION_ASSIGNMENT_PARSER = "(\\s)*String\\s+"+NAME_FORMAT+"\\s*=\\s*"+
            CHAR_FORMAT+ "\\s*(\\s*,\\s*"+NAME_FORMAT+"\\s*=\\s*"+CHAR_FORMAT+"\\s*)*(\\s*,\\s*"+
            CHAR_FORMAT+")*;";
