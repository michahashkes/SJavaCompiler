...
public class RegexScopes {
    ...
    public static final String METHOD_CALL = "\\s*" + METHOD_NAME + "\\s*\\(" + RegexGlobals.BOOLEAN_FORMAT + "|" +
            RegexGlobals.CHAR_FORMAT + RegexGlobals.STRING_FORMAT + ")(\\s*,\\s*" +
            RegexGlobals.BOOLEAN_FORMAT+"|"+RegexGlobals.INT_FORMAT+"|"+RegexGlobals.STRING_FORMAT + ")*\\s*\\)\\s*;";
